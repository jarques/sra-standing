...
export default function Row(props) {
  const rank = props.driverClass != 'Unrated' ? props.driverClass : '#000'
  return (
    <HStack key={props.key} bgColor='rgba(0,0,0,.9)' p={'2'} rounded='lg' maxW='580px' mb='1' mr='1'>
        <Box 
          bgColor="#FFF" 
          width="40px" 
          pt='2' 
        ...
        >
          <Text fontSize={'lg'} fontWeight='bold'>{props.key+1}</Text>
        </Box>
